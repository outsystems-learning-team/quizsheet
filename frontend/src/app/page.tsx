...
export default function StartPage() {
  ...
  const { setQuestions, isLoading, setIsLoading, setAnsweredCount, setCorrectCount, setStreak, setCategoryStats, setIncorrectQuestions, resetQuizState } = useContext(QuizContext);
  ...
  }, [setIsLoading, setAnsweredCount, setCorrectCount, setStreak, setCategoryStats]);
  ...
  return (
    <form
      ...
      className="max-w-md sm:max-w-lg md:max-w-4xl mx-auto bg-primary-bg p-4 sm:p-6 rounded-lg shadow"
    >
        ...
        <>
          ...
          <div className="flex justify-end mb-2">
            <button
              ...
              className="px-4 py-2 border border-foreground rounded-md text-sm font-medium hover:bg-secondary-bg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-2"
            >
              全て選択
            </button>
            <button
              ...
              className="px-4 py-2 border border-foreground rounded-md text-sm font-medium hover:bg-secondary-bg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              全て解除
            </button>
          </div>
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2">
          ...
          {selectedNumQuestionsOption === "free" && (
            <input
              ...
              className="w-24 border border-foreground rounded p-2 ml-2"
            />
          )}
        </div>
      </div>
